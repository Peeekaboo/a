...
// @description	  A cold, dark & frosty theme. Cleaned up Discord's UI a bit and implemented a nice dark background image. Keep it default or feel free to set your own image!
// @author        Hammock
// @homepage      https://userstyles.org/styles/125610
// @include       http://discordapp.com/*
// @include       https://discordapp.com/*
// @include       http://*.discordapp.com/*
// @include       https://*.discordapp.com/*
// @run-at        document-start
// @version       0.20180118054449
// ==/UserScript==
(function() {var css = [
	"/* 	",
	"	MAIN VARS",
	...
	".app,",
	".callout-backdrop {",
	"	background: url(https://i.imgur.com/XsdyYcd.jpgg) !important;",
	...
	"	height:40px;",
	"	content:\'\';",
	"	background-image: url(https://i.imgur.com/XsdyYcd.jpg) !important;",
	"	background-size:110%;",
